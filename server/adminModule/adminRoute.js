...
const manipulateBal = require("./maniplateBal/manipulateBal");
...
// Manipulate Bal
router.post("/add-balance", AuthMid, manipulateBal.addBal);
router.post("/subtract-balance", AuthMid, manipulateBal.subtractBal);
